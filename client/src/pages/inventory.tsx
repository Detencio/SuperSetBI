                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left p-4 font-medium text-text-secondary">Categoría</th>
                      <th className="text-left p-4 font-medium text-text-secondary">Precio</th>
                      ...
                      <th className="text-left p-4 font-medium text-text-secondary">Valor Total</th>
                    </tr>
                  </thead>
                  <tbody>
